...
const MedicationSchedule = () => {
  ...
  const loadData = async () => {
    try {
      setLoading(true)
      const [medicationsData, elderlyData] = await Promise.all([
        medicationService.getUpcomingMedications(),
        elderlyService.getAllElderly()
      ])
  ...
  const groupMedicationsByTime = (medications) => {
    ...
    medications.forEach(med => {
      const time = new Date(med.nextDose).toLocaleTimeString('en-US', {
        hour: '2-digit',
        minute: '2-digit',
        hour12: true
      })
    ...
    <div className="p-6">
      ...
      {groupedMedications.length === 0 ? (
        <div className="text-center py-12">
          <div className="text-gray-500 text-lg">No medications scheduled for this date</div>
        </div>
      ) : (
            ...
            <div key={time} className="bg-white rounded-lg shadow-md p-6">
              ...
              <div className="space-y-3">
                {medications.map(medication => (
                  <div key={medication._id} className="flex items-center justify-between p-4 border border-gray-200 rounded-lg">
                      ...
                      <div className="flex items-center space-x-4">
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-sm text-gray-500">
                            Patient: {medication.elderly.firstName} {medication.elderly.lastName}
                          </p>
                    ...
                    <div className="flex-shrink-0">
                      <button
                        onClick={() => markAsTaken(medication._id, medication.elderly._id)}
